...
export async function UiSettingsInjector() {
  ...
  // Inject CSS variables as inline style in a blocking script
  const cssVars = `
    :root {
      --menu-section-size: ${uiSettings.sectionTitleSize}px;
      --menu-category-size: ${uiSettings.categoryTitleSize}px;
      --menu-item-name-size: ${uiSettings.itemNameSize}px;
      --menu-item-desc-size: ${uiSettings.itemDescriptionSize}px;
      --menu-item-price-size: ${uiSettings.itemPriceSize}px;
      --header-logo-size: ${uiSettings.headerLogoSize}px;
      --bottom-nav-section-size: ${uiSettings.bottomNavSectionSize}px;
      --bottom-nav-category-size: ${uiSettings.bottomNavCategorySize}px;
    }
  `
